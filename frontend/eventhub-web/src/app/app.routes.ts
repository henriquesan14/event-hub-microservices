...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./features/events/event-editor.page').then(m => m.EventEditorPage),
  ...
  },
  {
    ...
    canActivate: [authGuard],
    loadComponent: () => import('./features/events/ticket-manager.page').then(m => m.TicketManagerPage),
  ...
  {
    path: 'confirm-email',
    loadComponent: () => import('./features/auth/confirm-email.page').then(m => m.ConfirmEmailPage),
  ...
  },
  {
    path: 'meus-ingressos',
    canActivate: [authGuard],
    loadComponent: () => import('./features/account/my-tickets.page').then(m => m.MyTicketsPage),
    title: 'Meus ingressos | EventHub',
  },
  {
    path: 'checkout/:paymentId',
    canActivate: [authGuard],
    loadComponent: () => import('./features/payments/checkout.page').then(m => m.CheckoutPage),
