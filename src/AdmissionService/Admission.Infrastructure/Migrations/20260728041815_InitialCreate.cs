        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckInIpAddress = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_admission_tickets_Code",
                table: "admission_tickets",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_admission_tickets_EventId",
                table: "admission_tickets",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_admission_tickets_ReservationId",
                table: "admission_tickets",
                column: "ReservationId");

            migrationBuilder.CreateIndex(
                name: "IX_admission_tickets_UserId",
                table: "admission_tickets",
                column: "UserId");
